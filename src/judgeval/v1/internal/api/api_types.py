...
#   filename:  tmpbffeh1qw.json
#   timestamp: 2026-01-19T09:22:45+00:00
...
class DatasetsCreateForJudgevalPostResponse400(TypedDict):
    error: str
...
class EvaluateExamplesPostRequestCustomScorersItem(TypedDict):
    score_type: str
    name: NotRequired[Optional[str]]
...
class EvaluateExamplesPostRequestJudgmentScorersItem(TypedDict):
    score_type: str
    name: NotRequired[Optional[str]]
    threshold: float
    model: NotRequired[Optional[str]]
...
class EvaluateExamplesPostRequest(TypedDict):
    ...
    custom_scorers: List[EvaluateExamplesPostRequestCustomScorersItem]
    judgment_scorers: List[EvaluateExamplesPostRequestJudgmentScorersItem]
    examples: List[DatasetsCreateForJudgevalPostRequestExamplesItem]
    trace_span_id: NotRequired[Optional[str]]
    trace_id: NotRequired[Optional[str]]


class EvaluateTracesPostRequest(TypedDict):
    id: NotRequired[Optional[str]]
    project_name: str
    eval_name: str
    model: NotRequired[Optional[str]]
...
class AddToRunEvalQueuePostRequest1(TypedDict):
    ...
    user_id: NotRequired[str]
    scorers: NotRequired[Optional[List]]
    custom_scorers: NotRequired[List[EvaluateExamplesPostRequestCustomScorersItem]]
    judgment_scorers: NotRequired[List[EvaluateExamplesPostRequestJudgmentScorersItem]]
    examples: List[DatasetsCreateForJudgevalPostRequestExamplesItem]
    trace_span_id: NotRequired[Optional[str]]
    trace_id: NotRequired[Optional[str]]
