...
async def generate_recommendations(state: State) -> State:
    ...
    from judgeval.common.tracer import current_span_var, current_trace_var
    print("langgraph_demo: current_span_var: ", current_span_var.get())
    print("langgraph_demo: current_trace_var: ", current_trace_var.get())
