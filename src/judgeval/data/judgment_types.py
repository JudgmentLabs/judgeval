...
#   timestamp: 2025-09-16T23:30:53+00:00
...
class OtelTraceListItemRules(BaseModel):
    rule_id: Annotated[str, Field(title="Rule Id")]
    rule_name: Annotated[str, Field(title="Rule Name")]
...
class OtelTraceListItem(BaseModel):
    ...
    span_id: Annotated[str, Field(title="Span Id")]
    rules: Annotated[Optional[List[OtelTraceListItemRules]], Field(title="Rules")] = []
