...
#   timestamp: 2025-08-07T18:47:10+00:00
...
class BaseScorerJudgmentType(BaseModel):
    ...
    e2b_enabled: Annotated[Optional[bool], Field(title="E2B Enabled")] = False
...
class EvaluationRunJudgmentType(BaseModel):
    ...
    hosted_scorers: Annotated[
        Optional[List[ScorerConfigJudgmentType]], Field(title="Hosted Scorers")
    ] = Field(default_factory=list)
