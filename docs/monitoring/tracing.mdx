...
<Note>
Deep tracing is enabled by default. If you prefer to trace only explicitly decorated functions, you can disable it:
```python
...
// The trace will show the full flow from mainWithEval to generateResponse
