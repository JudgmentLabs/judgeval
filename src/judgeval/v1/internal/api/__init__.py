...
class JudgmentSyncClient:
    ...
    def health(self) -> HealthResponse:
        return self._request(
            "GET",
            url_for("/v1/health", self.base_url),
            {},
        )
    ...
    def evaluate_examples(self, payload: ExampleEvaluationRun) -> Any:
        return self._request(
            "POST",
            url_for("/v1/evaluate/examples", self.base_url),
            payload,
        )
    ...
    def evaluate_traces(self, payload: TraceEvaluationRun) -> Any:
        return self._request(
            "POST",
            url_for("/v1/evaluate/traces", self.base_url),
            payload,
        )
    ...
    def add_to_run_eval_queue_examples(
        ...
        return self._request(
            "POST",
            url_for("/v1/add_to_run_eval_queue/examples", self.base_url),
            payload,
        )
    ...
    def add_to_run_eval_queue_traces(
        ...
        return self._request(
            "POST",
            url_for("/v1/add_to_run_eval_queue/traces", self.base_url),
            payload,
        )
    ...
    def prompts_fetch(
        ...
        return self._request(
            "GET",
            url_for("/v1/prompts/fetch", self.base_url),
            query_params,
        )
    ...
    def prompts_insert(self, payload: InsertPromptRequest) -> InsertPromptResponse:
        return self._request(
            "POST",
            url_for("/v1/prompts/insert", self.base_url),
            payload,
        )
    ...
    def prompts_tag(self, payload: TagPromptRequest) -> TagPromptResponse:
        return self._request(
            "POST",
            url_for("/v1/prompts/tag", self.base_url),
            payload,
        )
    ...
    def prompts_untag(self, payload: UntagPromptRequest) -> UntagPromptResponse:
        return self._request(
            "POST",
            url_for("/v1/prompts/untag", self.base_url),
            payload,
        )
    ...
    def prompts_get_prompt_versions(
        ...
        return self._request(
            "GET",
            url_for("/v1/prompts/get_prompt_versions", self.base_url),
            query_params,
        )
    ...
    def traces_tags_add(self) -> Any:
        return self._request(
            "POST",
            url_for("/v1/traces/tags/add", self.base_url),
            {},
        )
