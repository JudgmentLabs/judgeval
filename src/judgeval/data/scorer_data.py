...
def create_scorer_data(scorer: BaseScorer) -> List[ScorerData]:
    ...
    scorers_result.append(
        ScorerData(
            ...
            score=scorer.score,
            minimum_score_range=scorer.minimum_scorer_range,
            maximum_score_range=scorer.maximum_scorer_range,
    ...
    if hasattr(scorer, "internal_scorer") and scorer.internal_scorer is not None:
        scorers_result.append(
            ScorerData(
                ...
                minimum_score_range=scorer.internal_scorer.minimum_scorer_range,
                maximum_score_range=scorer.internal_scorer.maximum_scorer_range,
