...
Check it out in our [Faithfulness](/evaluation/scorers/faithfulness) scorer!

<Tip>
We'll be releasing a report soon detailing some of the novel techniques we've developed—stay tuned! 
</Tip>

Our implementations for other metrics are described on their respective documentation pages. 
All Judgment default scorers are backed by **leading industry/academic research** and are preferable to other implementations because:
