...
# Or enable it for specific functions
...
Judgment's tracing system can capture interactions between multiple agents in your system:
...
@judgment.observe(name="agent_2", span_type="agent")
def agent_2(data):
...
This approach provides end-to-end visibility into complex multi-agent systems, helping you understand how information flows between agents and identify bottlenecks or issues in your agent interactions.
